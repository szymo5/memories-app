...
const Auth = () => {
    ...
    const googleSuccess = async (res) => {
        //console.log(error);
        //console.log(res);
        const result = res?.profileObj; // ?. don't throw an error if we don't have access to the res object
    ...
    const googleFailure = () => {
        console.log("Google Sign In was unsuccessfu. Try Again Later");
    }
        ...
        <Container component="main" maxWidth="xs">
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin 
                        clientId="190514079284-fbbfnb7cjlra4tb6i8eq6pr65c44hlfs.apps.googleusercontent.com"
                        render={(renderProps) => (
